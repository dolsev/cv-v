...
const Personal = function (){
    ...
    return <div className='centered-box'>
        ...
        <h3>About Me:</h3>
           ...
           <li className='animated'>As a Front-End React developer in a span of 1,5 years <strong>I helped business to build</strong>: CRM systems, chat application, landing pages, e-marketplace and one-page forms for personal customers.</li>
